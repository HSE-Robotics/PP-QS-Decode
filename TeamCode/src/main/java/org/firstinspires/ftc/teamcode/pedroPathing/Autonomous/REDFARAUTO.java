 ...
 */
@Configurable
@Autonomous(name = "RedFarAuto", group = "Worlds Reggie")
public class REDFARAUTO extends OpMode {
     ...
     */
    private Path Start;
    private PathChain StarttoShoot, ShoottoPickup, ShoottoLeave, PickuptoShoot, ShootToSpike3;
    // Original: new Pose(56, 8, Math.toRadians(90));
    ...
    // Original: new Pose(18, 26, Math.toRadians(190));
    private final Pose leavingPose = new Pose(100, 26, Math.toRadians(-10)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose spike3Get = new Pose(100, 31, Math.toRadians(180)); // Scoring Pose of our robot. It is facing the goal at 47 degree angle.
...
//        /* This is our grabPickup2 PathChain. We are using a single path with a BezierLine, which is a straight line. */
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                if (!spike3){
                    if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 1.75 && intake < 3) {
                        follower.followPath(ShoottoPickup, 0.67, true);
