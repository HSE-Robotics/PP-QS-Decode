...
public class ReggieBlueCloseAuto_v3 extends OpMode {
    ...
    private final Pose pickThirdBallMiddleRowPosePPG = new Pose(19, yMidRowPurple+2, Math.toRadians(pickingAngle)); // Scoring Pose of our robot. It is facing the goal at 47 degree angle.
    private final Pose pickThirdBallMiddleRowControlPosePPG = new Pose(29, 81, Math.toRadians(pickingAngle)); // Scoring Pose of our robot. It is facing the goal at 47 degree angle.
