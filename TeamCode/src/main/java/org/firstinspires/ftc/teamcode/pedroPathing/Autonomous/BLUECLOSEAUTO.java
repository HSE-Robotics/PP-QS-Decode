 ...
 */
@Configurable
@Autonomous(name = "BlueCloseAutoWorlds", group = "Worlds Reggie")
public class BLUECLOSEAUTO extends OpMode {
    ...
    private final Pose startPose = new Pose(33, 136, Math.toRadians(90)); // Start Pose of our robot.
    private final Pose shootPose = new Pose(44.5, 109.5, Math.toRadians(130));
    ...
    private final Pose middleRowStart1 = new Pose(47, yMidRow+5.5, Math.toRadians(180));
    private final Pose middleRowEnd1=new Pose(23,yMidRow+5.5, Math.toRadians(180));
    private final Pose middleRowStart2=new Pose(40 ,yMidRow+2.5, Math.toRadians(180));
    private final Pose middleRowEnd2=new Pose(18,yMidRow+2.5, Math.toRadians(180));
    private final Pose middleRowEnd2controlpoint =new Pose(57,yMidRow+6.5, Math.toRadians(180));

    private final Pose opengate1=new Pose(22,76, Math.toRadians(157.5));
    private final Pose opengateforward1=new Pose(13.75,77.25, Math.toRadians(151.5));

    private final Pose opengate1curve =new Pose(60,75);
    private final Pose topRowStart =new Pose(47,105, Math.toRadians(180) );
    private final Pose topRowEnd =new Pose(19,105, Math.toRadians(180));
...
//    }
    public void buildPaths() {
        ...
        TopRowEndtoShoot4 = follower.pathBuilder()
                .addPath(new BezierLine(topRowEnd,shootPose4))
        ...
        switch (pathState) {
            ...
            case 4:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 1.25) {
                    follower.followPath(MiddleRowEnd1toMiddleRowStart2, true);
            ...
            case 5:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 1.25) {
                    follower.followPath(MiddleRowStart2toMiddleRowEnd2, 0.3, true);
                    setPathState(6);
            ...
            case 7:
                ...
                break;
            case 8:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 2.0 && gate < 2) {
                ...
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 1.25 && gate == 2) {
                    setPathState(12);
            ...
            case 14:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() >= 1.0) {
                    follower.followPath(TopRowEndtoShoot4, 0.9, true);
