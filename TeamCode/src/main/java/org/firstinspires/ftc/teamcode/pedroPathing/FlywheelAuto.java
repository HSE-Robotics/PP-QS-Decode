...
public class FlywheelAuto {
    ...
    private final double GATE_OPEN = 90;
    private final double GATE_OPEN_TIME = 0.5;
    private final double GATE_RESET_TIME = 0.2;


    private int shotsRemaining = 0;

    private double flywheelVelocity; // placeholder for a real DC motor
    private final double MIN_FLYWHEEL_RPM = 800;
    private final double TARGET_FLYWHEEL_RPM = 1.0; // set to actual rpm
    private final double FLYWHEEL_MAX_SPINUP_TIME = 2.5;
    ...
    public void init(HardwareMap hwMap) {
        ...
        flywheelVelocity = 0; // start flywheel stopped
        gateServo.setPosition(GATE_CLOSED); // init servo to starting position
    ...
    public void fireShots(int numberOfShots) {
        // only fire if the flywheel isn't presently firing (stops mis fire logic)
