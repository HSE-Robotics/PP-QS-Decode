 ...
 */
@Autonomous(name = "BLUE_FAR_LEAVELEFT", group = "Regionals Reggie Far")
public class ReggieAutoFARBLUE_LEAVELEFT extends OpMode {
    ...
    private final Pose scorePose = new Pose(58, 21, Math.toRadians(110)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    private final Pose park = new Pose(20, 9, Math.toRadians(90)); // Highest (First Set) of Artifacts from the Spike Mark.
