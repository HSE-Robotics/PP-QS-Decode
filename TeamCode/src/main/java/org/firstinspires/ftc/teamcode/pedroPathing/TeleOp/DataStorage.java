...
public class DataStorage {
    ...
    public static Pose BlueShoot = new Pose(85,35,Math.toRadians(125));
    ...
    public static Pose RedShoot = new Pose(55,24,Math.toRadians(57));
    public static Pose RedShootFAR = new Pose(54,16,Math.toRadians(57));
}
